...
def add_AServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "main.A", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("main.A", rpc_method_handlers)
...
def add_BServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "hello": grpc.unary_unary_rpc_method_handler(
            servicer.hello,
            request_deserializer=main__pb2.ARequest.FromString,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "main.BServer", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("main.BServer", rpc_method_handlers)
